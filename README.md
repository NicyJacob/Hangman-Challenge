...
The code is written as part of a guided challenge. The code uses Object Oriented Programming(OOP) in Python. OOP helped in implementing the functionalities of the game clearly. It also gives a structured approach to the challenge.

#**Installation**
The code is written using vscode (IDE/Text editor).
...
6. If the guessed letter is not present in the word, you can try to guess another letter.
